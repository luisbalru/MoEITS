...
if __name__ == '__main__':
    deepseek_simp_service = DeepSeekMoE_Simplification_Service('deepseek-ai/deepseek-moe-16b-base', factor=1)
    ...
    simplified_deepseek_moe.save_pretrained('simplified_models/deepseek-moe-16b-f3/')